        ...
        <div className="w-full flex flex-col mt-12 mb-7 sm:flex-row h-fit ">
          ...
          <div className="sm:flex-1">
            <div>
              ...
              development to create amazing user experiences and tackle complex
              ...
              of these domains to deliver innovative solutions. Join me on this
              exciting digital journey, explore my projects, and let&apos;s
              collaborate to create something extraordinary together!
            </div>
          </div>
        </div>
        <div className="w-full flex flex-col mt-12 mb-7 sm:flex-row h-fit ">
            ...
            <ul className="list-disc list-inside">
              ...
              <li>
                ...
                <span className="text-sm">
                  HTML, Tailwind, React.js, Next.js
                </span>
              </li>
              <li>
              ...
              <li>
                Databases:{" "}
                <span className="text-sm">MongoDB, Firebase, SQL</span>
              </li>
              <li>
                Cloud:{" "}
          ...
          <div className="sm:flex-1">
            <div className="mb-5">
              ...
              <div className=" mt-2">
                ...
                Leveraging my expertise in technologies such as JavaScript,
                Node.js, React, and responsive design principles, I build
                captivating web experiences. From crafting engaging user
                interfaces to implementing robust backend functionalities, I
                strive to deliver high-quality web solutions that meet the
            ...
            <div className="mb-5">
              ...
              <div className="w-full border-b-2 border-white"></div>
              <div className=" mt-2">
                I excel in developing robust backends and powerful APIs that
                serve as the backbone of web and mobile applications. Leveraging
                my expertise in technologies like Node.js, Express.js, and
                database management systems, I design and implement secure and
                scalable server-side logic. From creating RESTful APIs for
                seamless communication between frontends and backends to
                integrating with third-party services, I ensure efficient data
                management and smooth functionality, enabling applications to
            ...
            <div className="mb-5">
              ...
              <div className=" mt-2">
                ...
                consultancy services to guide businesses through the dynamic
                tech landscape. From technology stack selection to system
                architecture, I provide tailored recommendations to optimize
                digital initiatives. Additionally, I provide comprehensive
                maintenance for your digital assets, ensuring their reliability
                and security. With a focus on your goals and ongoing support, I
